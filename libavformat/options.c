...
#if LIBAVFORMAT_VERSION_INT < (53<<16) && CONFIG_ENCODERS
...
{"indexmem", "max memory used for timestamp index (per stream)", OFFSET(max_index_size), FF_OPT_TYPE_INT, (1<<20) - 4, 0, INT_MAX, D},	// XXX: mhfan
{"rtbufsize", "max memory used for buffering real-time frames", OFFSET(max_picture_buffer), FF_OPT_TYPE_INT, (1<<20) - 4, 0, INT_MAX, D}, /* defaults to 1s of 15fps 352x288 YUYV422 video, XXX: mhfan */
