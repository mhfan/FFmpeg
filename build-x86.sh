...
#CFLAGS="$CFLAGS -Wno-unused-function -Wno-uninitialized -Wno-extra"
#CFLAGS="$CFLAGS -Wno-cast-qual -Wno-inline -Wno-format"
#CFLAGS="$CFLAGS -Wno-bad-function-cast -Wno-unused"
